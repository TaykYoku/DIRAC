...
class TornadoBaseClient(object):
  ...
  KW_AUTH_TYPE = "authenticationType" ##
  KW_USE_CERTIFICATES = "useCertificates"
  KW_EXTRA_CREDENTIALS = "extraCredentials"
  KW_TIMEOUT = "timeout"
  KW_SETUP = "setup"
  KW_VO = "VO"
  # For "token" authentication type ## 
  KW_TOKEN_LOCATION = "tokenLocation" ##
  KW_TOKEN_STRING = "tokenString" ##
  ...
  def __init__(self, serviceName, **kwargs):
    """
      ...
      :param authType: authentication type. Possible values are "bearer", "proxy", "certificates".
      ...
      :param tokenLocation: Specify the location of the token
      :param tokenString: Specify the token string
    ...
    for initFunc in (
            ...
            self.__discoverVO,
            self.__discoverAuthenticationMethod, ##
  ...
  ##
  def __discoverAuthenticationMethod(self):
    """ Discover which authentication method to use and stores it in self.__authType
        The authentication method is looked for:
           * kwargs of the constructor (see KW_VO)
           * in the CS /DIRAC/VirtualOrganization
           * default to 'unknown'
